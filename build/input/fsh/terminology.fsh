...
Description: "NMDP language codes — includes NMDP internal codes and standard IETF BCP 47 language tags"
* include codes from system nmdp-language-cs
* $BCP47#ar       "Arabic"
* $BCP47#ar-AE    "Arabic (United Arab Emirates)"
* $BCP47#ar-BH    "Arabic (Bahrain)"
* $BCP47#ar-DZ    "Arabic (Algeria)"
* $BCP47#ar-EG    "Arabic (Egypt)"
* $BCP47#ar-IQ    "Arabic (Iraq)"
* $BCP47#ar-JO    "Arabic (Jordan)"
* $BCP47#ar-KW    "Arabic (Kuwait)"
* $BCP47#ar-LB    "Arabic (Lebanon)"
* $BCP47#ar-LY    "Arabic (Libya)"
* $BCP47#ar-MA    "Arabic (Morocco)"
* $BCP47#ar-OM    "Arabic (Oman)"
* $BCP47#ar-QA    "Arabic (Qatar)"
* $BCP47#ar-SA    "Arabic (Saudi Arabia)"
* $BCP47#ar-SY    "Arabic (Syrian Arab Republic)"
* $BCP47#ar-TN    "Arabic (Tunisia)"
* $BCP47#ar-YE    "Arabic (Yemen)"
* $BCP47#zh       "Chinese"
...
* $BCP47#en-IE    "English (Ireland)"
* $BCP47#en-NZ    "English (New Zealand)"
* $BCP47#en-US    "English (United States)"
* $BCP47#en-ZA    "English (South Africa)"
* $BCP47#fr       "French"
* $BCP47#fr-BE    "French (Belgium)"
* $BCP47#fr-CA    "French (Canada)"
...
* $BCP47#ja       "Japanese"
* $BCP47#ja-JP    "Japanese (Japan)"
* $BCP47#ko       "Korean"
* $BCP47#ko-KR    "Korean (Korea)"
* $BCP47#pt       "Portuguese"
* $BCP47#pt-BR    "Portuguese (Brazil)"
* $BCP47#pt-PT    "Portuguese (Portugal)"
* $BCP47#ru       "Russian"
* $BCP47#ru-RU    "Russian (Russia)"
* $BCP47#es       "Spanish"
* $BCP47#es-AR    "Spanish (Argentina)"
* $BCP47#es-CL    "Spanish (Chile)"
* $BCP47#es-CO    "Spanish (Colombia)"
* $BCP47#es-ES    "Spanish (Spain)"
* $BCP47#es-MX    "Spanish (Mexico)"
* $BCP47#es-PR    "Spanish (Puerto Rico)"
* $BCP47#vi       "Vietnamese"
* $BCP47#vi-VN    "Vietnamese (Vietnam)"
* ^experimental = true
