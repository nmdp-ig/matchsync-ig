# CodeSystem - Patient Ethnicity - CDC - v0.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CodeSystem - Patient Ethnicity - CDC**

## CodeSystem: CodeSystem - Patient Ethnicity - CDC (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:urn:oid:2.16.840.1.113883.6.238 | *Version*:0.1.4 |
| Active as of 2026-04-24 | *Computable Name*:CDCRaceEthnicityCS |

 
Code System for CDC race and ethnicity 

 This Code system is referenced in the content logical definition of the following value sets: 

* [NMDPEthnicityVS](ValueSet-nmdp-ethnicity-codes.md)
* [NMDPRaceVS](ValueSet-nmdp-race-codes.md)
