# HLA-DRB5-Example - v0.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HLA-DRB5-Example**

## Example Observation: HLA-DRB5-Example

Profile: [HLA_DRB5](StructureDefinition-hla-drb5.md)
...
**value**: hla#3.25.0#HLA-DRB5*01:01:01:01
...
```json
{
  ...
  "valueCodeableConcept" : {
    "coding" : [{
      ...
      "code" : "hla#3.25.0#HLA-DRB5*01:01:01:01"
    }]
  },
  "specimen" : {
