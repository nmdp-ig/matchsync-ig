# HLA-DRB3-Example - v0.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HLA-DRB3-Example**

## Example Observation: HLA-DRB3-Example

Profile: [HLA_DRB3](StructureDefinition-hla-drb3.md)
...
**value**: hla#3.25.0#HLA-DRB3*01:01:02:01
...
```json
{
  ...
  "valueCodeableConcept" : {
    "coding" : [{
      ...
      "code" : "hla#3.25.0#HLA-DRB3*01:01:02:01"
    }]
  },
  "specimen" : {
