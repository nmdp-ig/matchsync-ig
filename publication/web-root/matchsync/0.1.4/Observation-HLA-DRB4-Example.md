# HLA-DRB4-Example - v0.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HLA-DRB4-Example**

## Example Observation: HLA-DRB4-Example

Profile: [HLA_DRB4](StructureDefinition-hla-drb4.md)
...
**value**: hla#3.25.0#HLA-DRB4*01:01:01:01
...
```json
{
  ...
  "valueCodeableConcept" : {
    "coding" : [{
      ...
      "code" : "hla#3.25.0#HLA-DRB4*01:01:01:01"
    }]
  },
  "specimen" : {
